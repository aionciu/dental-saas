...
export default function Header({ toggleSidebar }: { toggleSidebar: () => void }) {  const [darkMode, setDarkMode] = useState(false);
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:block text-right">
            <p className="text-sm font-medium text-gray-800 dark:text-white">Dr. Alexandru</p>
            <a href="/profile" className="text-xs text-blue-500 hover:underline">View Profile</a>
          </div>
        </div>
      </div>
    </header>
